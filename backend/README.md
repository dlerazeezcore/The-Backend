...
- `TELEGRAM_SUPPORT_CONVERSATIONS_TABLE` default `support_conversations`
- `TELEGRAM_SUPPORT_MESSAGES_TABLE` default `support_messages`
- `TELEGRAM_SUPPORT_MAP_TABLE` default `support_telegram_map`
